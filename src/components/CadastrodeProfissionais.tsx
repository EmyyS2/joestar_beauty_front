                        ...
                        <div className='card-body'>
                            ...
                            <form onSubmit={cadastrarUsuario} className='row g-3'>
                                ...
                                <div className='col-4'>
                                    ...
                                    <input type="text" value={cidade} id='cidade' name='cidade' className='form-control' required onChange={handleState}placeholder='Presidente Prudente' /><div className='text-danger'>{cidadeError}</div>
                                </div>
                                <div className='col-4'>
                                ...
                                <div className='col-6'>
                                    ...
                                    <input type="decimal" name='salario' className='form-control' required onChange={handleState} /><div className='text-danger'>{salarioError}</div>
                                </div>
                                <div className='col-4'>
